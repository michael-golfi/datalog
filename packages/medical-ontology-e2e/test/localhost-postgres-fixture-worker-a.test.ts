...
const workerProofLabel = 'worker-a';
const workerCollisionProofEnabled = process.env.MEDICAL_ONTOLOGY_E2E_RUN_WORKER_COLLISION_PROOF === '1';

(workerCollisionProofEnabled ? it : it.skip)('records a worker-specific database name for the two-worker collision proof', async () => {
