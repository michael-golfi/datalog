...
import { parseDatalogProgramSources, type ParsedDatalogProgramSources } from '@datalog/parser';

import type { DatalogWorkspaceDocument } from './load-datalog-workspace-documents.js';

type LoadMigrationProjectFiles = (options: {
...
function buildParsedWorkspaceProgram(
  ...
  try {
    return parseDatalogProgramSources(
